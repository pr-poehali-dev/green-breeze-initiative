  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Йога изменила мою жизнь. Я нашла спокойствие, уверенность в себе и гармонию.
          Преподаватели студии помогли мне найти свой путь и идти по нему уверенно.
        </blockquote>
        ...
        >
          ...
          <p className="text-sm text-primary-foreground/60 mt-1">Ученица студии, 2 года практики</p>
        </div>
      </div>
    </section>
  )
